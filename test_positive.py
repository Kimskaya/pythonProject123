...
def checkout(cmd, text):
    ...
    if text in result.stdout and result.returncode == 0:
        ...
        return False
def test_step1():
    result1 = checkout("cd {}; &z a {}/arx2".format(tst, out), "Everything is ok")
...
def test_step6():
    result1 = checkout("cd {}; 7z x arx2.7z -o{} -y".format(out, folder2), "Everythin is Ok")
...
def test_step7():
    result = subprocess.run("cd {}; arx2.7z".format(out), shell=True, stdout = subprocess.PIPE, encoding='utf-8')
